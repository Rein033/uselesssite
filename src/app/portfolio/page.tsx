...
function LinkRow({ item, isApi }: { item: LinkItem; isApi?: boolean }) {
  ...
  if (item.path.includes('[')) return <div className="opacity-50 cursor-default">{inner}</div>
  if (item.external) return <a href={item.path} target="_blank" rel="noopener noreferrer">{inner}</a>
        ...
        <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
          ...
          <header className="border border-green-900 p-5 space-y-4">
            <div className="flex justify-between items-center flex-wrap gap-2">
              ...
              <span className="text-xs"><span className="text-green-700">STATUS: </span><span className="text-green-400 animate-pulse">● ONLINE</span></span>
            </div>
            <div className="border-t border-green-900/50 pt-4 space-y-1.5 text-sm">
              ...
              <div className="pt-1"><span className="text-green-700">C:\REIN&gt; </span><span className="retro-cursor text-green-500" /></div>
            </div>
            <div className="border-t border-green-900/50 pt-4 flex flex-wrap gap-3">
              <a href="https://github.com/Rein033" target="_blank" rel="noopener noreferrer" className="text-xs border border-green-800 hover:border-green-500 px-4 py-2 transition-colors hover:bg-green-950/50 hover:text-green-200 text-green-600">
                [ GITHUB → ]
              </a>
            </div>
          </header>
          ...
          <footer className="border-t border-green-900/40 pt-5 space-y-1 text-xs text-green-800">
            <div className="flex justify-between flex-wrap gap-2">
              ...
              <a href="https://github.com/Rein033" target="_blank" rel="noopener noreferrer" className="hover:text-green-500 transition-colors">GITHUB.COM/REIN033</a>
            </div>
            <div className="text-green-900">VOOR NOODGEVALLEN: 0118 999 881 999 119 725 3</div>
            <div className="text-green-900/50 text-[10px] pt-1">TIP: OPEN DE BROWSER CONSOLE · PROBEER DE KONAMI CODE ↑↑↓↓←→←→BA</div>
          </footer>
